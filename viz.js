...
let nodeColor = d3
  .scaleOrdinal()
  .range(["#20578a", "#dadbde", "#d9534f", "#527772", "#bf79b4", "#ffd800"]);
let linkColor = d3
  .scaleOrdinal()
  .range(["#20578a", "#d9534f", "#527772", "#bf79b4", "#ffd800"]);
...
d3.json("./data/project.json").then(data => {
  ...
  let text = svg
    ...
    .attr("y", ".3em")
    .attr("font-size", (d) => {
      return textSize(d.group);
    })
    .attr("font-weight", (d) => {
      return textWeight(d.group);
    })
    .text(function (d) {
      return d.id;
    });
